...
1. [Git 是什么，用来干什么](#1-git-是什么用来干什么)
2. [核心概念：Git 的工作模型](#2-核心概念git-的工作模型)
3. [安装与初始配置](#3-安装与初始配置)
4. [基础操作：提交你的第一个快照](#4-基础操作提交你的第一个快照)
5. [查看历史：读懂项目演进轨迹](#5-查看历史读懂项目演进轨迹)
6. [撤销与修复：出错了怎么办](#6-撤销与修复出错了怎么办)
7. [分支：并行开发的核心机制](#7-分支并行开发的核心机制)
8. [远程协作：与团队共享代码](#8-远程协作与团队共享代码)
9. [合并与变基：整合代码的两种策略](#9-合并与变基整合代码的两种策略)
10. [冲突处理：遇到冲突不要慌](#10-冲突处理遇到冲突不要慌)
11. [标签与发布管理](#11-标签与发布管理)
12. [高级技巧：效率与历史治理](#12-高级技巧效率与历史治理)
13. [命令速查总表](#13-命令速查总表)
14. [延伸阅读](#14-延伸阅读)
